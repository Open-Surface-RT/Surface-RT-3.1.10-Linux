...
//		   name		dev_id		      con_id  clk_num  reg      max_Rate   inputs                      flags        ops
...
struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("sdmmc1",	"sdhci-tegra.0",	NULL,		14,	0x150,	208000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71), //sdcard /* scales with voltage */
	PERIPH_CLK("sdmmc2",	"sdhci-tegra.1",	NULL,		9,	0x154,	50000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71), //unused /* scales with voltage */
	PERIPH_CLK("sdmmc3",	"sdhci-tegra.2",	NULL,		69,	0x1bc,	208000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71), //wifi /* scales with voltage */
	PERIPH_CLK("sdmmc4",	"sdhci-tegra.3",	NULL,		15,	0x164,	102000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71), //emmc /* scales with voltage */
